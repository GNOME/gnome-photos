...
photos_application_startup (GApplication *application)
{
  ...
  const gchar *zoom_in_accels[5] = {"<Primary>plus", "<Primary>equal", "<Primary>KP_Add", "ZoomIn", NULL};
  const gchar *zoom_out_accels[4] = {"<Primary>minus", "<Primary>KP_Subtract", "ZoomOut", NULL};
