...
#define _PARAM_READWRITE G_PARAM_READWRITE|G_PARAM_STATIC_NAME|G_PARAM_STATIC_BLURB
                                    ...
                                    guint64 frame_time)
{
  ...
  delta = (frame_time - tracker->last_frame_time) / (double)tracker->duration;
  tracker->last_frame_time = frame_time;
