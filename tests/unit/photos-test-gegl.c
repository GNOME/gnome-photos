...
photos_test_gegl_setup (PhotosTestGeglFixture *fixture, gconstpointer user_data)
{
  ...
  crop = gegl_node_new_child (graph, "operation", "gegl:crop", "height", 200.0, "width", 200.0, NULL);
  ...
  path_d = gegl_path_new_from_string ("M0,50 "
                                      ...
                                      "C25,0 0,20 0,50 "
                                      "z");
  path_fill = gegl_color_new ("rgba(1,1,1,0.2)");
  path_stroke = gegl_color_new ("rgba(0,0,1,0.5)");
...
photos_test_gegl_buffer_apply_orientation_bottom_0 (PhotosTestGeglFixture *fixture, gconstpointer user_data)
{
  ...
  g_assert_cmpstr (checksum, ==, "8706ed71aa02bd503f4aa42d987c34ee468412ced43cfc1bd8575247a2a16b11");
}
